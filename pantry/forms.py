...
class LocationForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'address']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., Home, Office'}),
            'address': forms.Textarea(attrs={'class': 'form-control', 'rows': 3, 'placeholder': 'Optional address'}),
        }   
...
class PantryItemForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'barcode': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., 123456789012'}),
            'default_storage': forms.Select(attrs={'class': 'form-control'}),
            'min_stock_level': forms.NumberInput(attrs={'class': 'form-control', 'min': '1'}),
        }