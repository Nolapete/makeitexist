...
class StorageUnit(models.Model):
    ...
    location = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='storage_units')
...
class PantryItem(models.Model):
    ...
    default_storage = models.ForeignKey(StorageUnit, on_delete=models.SET_NULL, null=True, blank=True)
    min_stock_level = models.PositiveIntegerField(
        default=1,
        help_text="Minimum quantity to keep in stock"
    )
    created_by = models.ForeignKey(User, on_delete=models.CASCADE)
...
class Stock(models.Model):
    item = models.ForeignKey(PantryItem, on_delete=models.CASCADE, related_name='stocks')
    storage_unit = models.ForeignKey(StorageUnit, on_delete=models.CASCADE, related_name='stocks')  # ✅ Add this
