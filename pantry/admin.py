...
class StorageUnitAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['temperature_fahrenheit'].initial = celsius_to_fahrenheit(celsius) if celsius else None
...
class StorageUnitAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'unit_type', 'location')
        }),
...
class StockAdmin(admin.ModelAdmin):
    ...
    list_filter = ('storage_unit__location', 'storage_unit__unit_type', 'purchase_date', 'expiry_date')
    ...
    fieldsets = (
        (None, {
            'fields': ('item', 'storage_unit')
        }),
        ('Stock Details', {
            'fields': ('quantity', 'purchase_date', 'batch_number')
        }),
        ('Expiry (Optional)', {
            'fields': ('expiry_date',),
            'classes': ('collapse',)
