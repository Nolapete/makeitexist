...
OSCAR_SHOP_NAME = "Make It Exist Studios"
OSCAR_FROM_EMAIL = "support@makeitexist.net"
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="webmaster@makeitexist.net")
